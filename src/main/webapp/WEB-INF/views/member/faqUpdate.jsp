...
<body>
	...
	<div class="title_wrap"
		style="width: 1000px; font-family: 'Nanum Gothic', sans-serif;">
		<h6 id="h6_title" style="margin-right: 5px; margin-top: 8px;">
			<a href="${pageContext.request.contextPath}"><img alt=""
				...
				href="${pageContext.request.contextPath}/member/memberMypage">MYPAGE</a>
			> <a href="${pageContext.request.contextPath}/member/orderlist">FAQ</a>
			> <a href="${pageContext.request.contextPath}/member/orderlist">FAQ
				UPDATE</a>
		</h6>
	</div>
			...
			<table>
				<tr>
					<td style="margin-left: 10px; float: left;">제목 : <input
						type="text" name="title" value="${view.title}" placeholder="제목을 입력해주세요."
						class="write_ip"
					...
					<td style="float: right; margin-right: 50px; padding-bottom: 20px;">작성자
						...
						class="write_ip" readonly="readonly"
						style="width: 150px; border: none; border-bottom: 1px solid lightgray; border-radius: 0px;">
					</td>
				</tr>
				<tr>
					<td class="content" colspan="2"><textarea id="contents"
							name="contents" draggable="false">${view.contents}</textarea></td>
				</tr>
			</table>
			<input type="submit" id="savebutton" value="UPDATE" class="btn btn-default">
		</form>
	</div>
